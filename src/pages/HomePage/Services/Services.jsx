...
const Services = () => {
    ...
    return ( 
        <div className="hero h-56 mb-64 mt-4 md:my-8" style={{ backgroundImage: `url("https://i.ibb.co/51bVYyv/services.jpg")`, borderRadius: '0.375rem' }}>
            <div className="hero-overlay rounded-md"></div>
            <div className="hero-content rounded-md text-center bg-sky-300 bg-opacity-70  flex flex-col md:flex-row justify-around  w-full h-full ">
