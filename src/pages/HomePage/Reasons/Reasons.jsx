    ...
    return (
        <div>
            <div>
                ...
                <p className="text-sm text-slate-500 md:text-base font-medium text-center w-1/2 mx-auto mb-8">Dive into a curated selection of top-quality toys that promote active play. Our commitment ensures kids engage, learn, and grow.</p>
            </div>
            <div 
