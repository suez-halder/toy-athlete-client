...
const AllToys = () => {
    ...
    const handleSearch = () => {
        ...
        fetch(`http://localhost:3000/alltoys/${searchText}`)
            .then(res => res.json())
            .then(data => {
                setToySearch(data);
            })
            ...
            <div className="w-1/5 mx-auto">
                <div className="py-8 text-base leading-6 space-y-4 text-gray-700 sm:text-lg sm:leading-7 flex items-center">
                    <div className="relative">
                        <input onChange={(e) => setSearchText(e.target.value)} id="search" name="search" type="text" className="peer placeholder-transparent h-10 w-full border-b-2 border-gray-300 text-gray-900 focus:outline-none focus:borer-rose-600" placeholder="Search Toy" />
