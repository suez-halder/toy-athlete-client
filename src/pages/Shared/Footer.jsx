...
const Footer = () => {
    return (
        <div>
            <footer className="px-4 divide-y dark:bg-sky-800 dark:text-gray-100 rounded-md">
                <div className="container flex flex-col justify-between py-10 mx-auto space-y-8 lg:flex-row lg:space-y-0 text-center md:text-left">
                    <div className="lg:w-1/3">
                        <p className="flex justify-center space-x-3 md:justify-start ">
                            <span className="h-10 md:h-14 w-1/3 md:w-1/2 mx-auto"><img className='rounded-md' src={logo} alt="logo" /></span>
                        </p>
                    </div>
